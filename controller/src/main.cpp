...
void setup(void) {
  ...
  Serial.println("INFO: Waiting for an ISO14443A Card ...");
}
...
void loop(void) {
  ...
  if (success) {
    ...
    Serial.println("INFO: Found an ISO14443A card");
    Serial.print("INFO:  UID Length: ");Serial.print(uidLength, DEC);Serial.println(" bytes");
    Serial.print("UID: ");
